...
public class checkuser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            ResultSet rs = base.consultaSql("SELECT * FROM usuario");

            if (rs == null) {
                System.out.println("No hay usuarios que coincidan con la busqueda");
            } else {
                while(rs.next()){
                    System.out.println(rs.getString("usuario"));
                    System.out.println(rs.getString("clave"));
                    System.out.println(rs.getString("nombre_apellido"+"<br>"));
                }
